                        ...
                        <?php foreach ($approved_items as $item): ?>
                            <tr>
                                ...
                                <td style="padding: 10px; border-bottom: 1px solid #eee;">
                                    ...
                                    <form action="../../actions/archive-item.php" method="POST" style="display:inline;">
                                        <input type="hidden" name="table" value="found_items">
                                        <input type="hidden" name="item_id" value="<?php echo $item['item_id']; ?>">
                                        <button type="submit" style="background-color: #607d8b; color: white; border: none; padding: 5px 10px; cursor: pointer; border-radius: 4px;">Archive</button>
                                    </form>
